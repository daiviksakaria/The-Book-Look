...
const IndividualBookVendor = ({ setProfileID, singleDoc }) => {
  ...
  const [buyOrRent, setBuyOrRent] = useState(null);
  ...
  function handleRequest(
    ...
    if (buyOrRent == "buy" || buyOrRent == null) {
      if (quantity == "") {
      ...
      if (rentQuantity == "") {
        setError("Please enter the number of copies you want to rent");
        return;
      }
    }
              ...
              ? owners.map((owner, ind) => {
                  ...
                  return (
                    <tr>
                      ...
                      >
                        <Link to="/homepage/profile">{owner.shopname}</Link>
                      </td>
                      <td>{owner.copies}</td>
                      <td>
                      ...
                      <td>{owner.rent ? owner.rent : "NA"}</td>
                      <td>{owner.delivery ? "Available" : "Not available"}</td>
                      <td>
                                      ...
                                      owner.rent === "" ? (
                                        ...
                                        <div className="form-group">
                                          <label
                                            ...
                                            className="request-label"
                                          >
                                            Do you want to buy the book or rent
                                            it?
                                          </label>
                                          <br></br>
                                          <label
...
export default IndividualBookVendor;
